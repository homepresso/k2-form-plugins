if (!window.__materialprogressbarRuntimeLoaded) {
  window.__materialprogressbarRuntimeLoaded = true;

/**
 * Material Progress Bar Control for K2 SmartForms
  ...
  if (!window.customElements.get('material-progress-bar')) {
    window.customElements.define('material-progress-bar', class MaterialProgressBar extends HTMLElement {
      ...
      _updateProgress() {
        ...
        // Fire complete event when reaching 100%
        if (value >= 100 && this._previousValue < 100 && !this._completeEventFired) {
      ...
      set mode(v) {
        ...
        if (this._hasRendered) this._render();
        safeRaisePropertyChanged(this, 'mode');
      }
      ...
      set thickness(v) {
        ...
        if (this._hasRendered) this._render();
        safeRaisePropertyChanged(this, 'thickness');
      }
      ...
      set showLabel(v) {
        ...
        if (this._hasRendered) this._render();
        safeRaisePropertyChanged(this, 'showLabel');
      }
      ...
      set customLabel(v) {
        this._customLabel = v || '';
        if (this._hasRendered) this._updateProgress();
        safeRaisePropertyChanged(this, 'customLabel');
      }
      ...
      set animated(v) {
        ...
        safeRaisePropertyChanged(this, 'animated');
      }
      ...
      set buffer(v) {
        ...
        if (this._hasRendered) this._render();
        safeRaisePropertyChanged(this, 'buffer');
      }
      ...
      set bufferColor(v) {
        ...
        if (this._hasRendered) this._applyStyles();
        safeRaisePropertyChanged(this, 'bufferColor');
      }
