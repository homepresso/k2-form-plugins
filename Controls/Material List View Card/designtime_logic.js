/**
 * Material List View Card Control for K2 SmartForms - Design Time
  ...
  if (!window.customElements.get('material-list-view-card')) {
    window.customElements.define('material-list-view-card', class MaterialListViewCard extends BaseClass {
      ...
      set List(value) {
        ...
        if (typeof value === 'string' && value.trim()) {
          try {
            ...
            console.warn('[Material List View Card DT] Failed to parse List value as JSON:', e);
          }
        }
      ...
      listItemsChangedCallback(itemsChangedEventArgs) {
        ...
        if (isDesignTime && (!Array.isArray(itemsToProcess) || itemsToProcess.length === 0)) {
          try {
            ...
            console.warn('[Material List View Card DT] Error parsing fallback initial value:', error);
          }
        }
        ...
        if (Array.isArray(itemsToProcess)) {
          ...
          console.warn('[Material List View Card DT] NewItems is not an array:', itemsChangedEventArgs);
        }
      }
      ...
      _processDataItems() {
        ...
        if (!this._dataItems || this._dataItems.length === 0) {
          console.log('[Material List View Card DT] No data items to process');
          return;
        }
